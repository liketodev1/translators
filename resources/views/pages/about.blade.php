                ...
                <div class="info-block">
                    ...
                    <div class="info-block-content">
                        <p>
                            ...
                            individual
                            clients to hire them without middlemen and to communicate directly with qualified translators.
                        </p>
                    </div>
    ...
    <section class="container-fluid container-t section about-end">
        <div class="row no-gutters about-end-bg">
            <div class="row no-gutters d-flex justify-content-around align-content-center">
                ...
                <div class="col-xl-3 col-lg-3 col-md-3 col-sm-12 about-end-button d-flex justify-content-center align-items-center">
                    <a href="{{route($route)}}">
