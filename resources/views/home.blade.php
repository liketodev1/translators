        ...
        <section id="section_container_home">
            <div id="content_home_container">
                <div class="content_home_blocks">
                    <div><img src="{{asset('img/Icon.svg')}}" alt=""></div>
                ...
                <div class="content_home_blocks">
                    <div><img src="{{asset('img/Icon%20(1).svg')}}" alt=""></div>
                ...
                <div class="content_home_blocks">
                    <div><img src="{{asset('img/Icon%20(2).svg')}}" alt=""></div>
                ...
                <div class="content_home_blocks">
                    <div><img src="{{asset('img/Icon%20(3).svg')}}" alt=""></div>
...
<div class="all_container">
    <section id="find_translators_container">
        ...
        <div id="translators_container_block">
            <div class="translators_container_block_row">
                ...
                <div class="translators_block_rows">
                    <img src="{{asset('img/Medical%20&%20Pharma.svg')}}" alt="">
                    <a href=""><h6>Medical & Pharma</h6></a>
                    <p>102 translators</p>
                </div>
                <div class="translators_block_rows">
                    <img src="{{asset('img/Technology%20&%20Software.svg')}}" alt="">
            ...
            <div class="translators_container_block_row" id="translators_container_block_row_2">
                <div class="translators_block_rows">
                    <img src="{{asset('img/Marketing%20&%20Advertising.svg')}}" alt="">
                    <a href=""><h6>Marketing & Advertising</h6></a>
                    <p>93 translators</p>
                </div>
                <div class="translators_block_rows">
                    <img src="{{asset('img/Travel,%20Leisure%20&%20Hospitality.svg')}}" alt="">
                    <a href=""><h6>Travel, Leisure & Hospitality</h6></a>
                    <p>4 translators</p>
                </div>
                <div class="translators_block_rows">
                    <img src="{{asset('img/Mobile%20&%20Video%20Games.svg')}}" alt="">
                    <a href=""><h6>Mobile & Video Games</h6></a>
                    <p>199 translators</p>
                </div>
                <div class="translators_block_rows">
                    <img src="{{asset('img/Multimedia.svg')}}" alt="">
    ...
    <section id="help_container">
        ...
        <img src="{{asset('img/Image%20(2).png')}}" alt="" class="img-fluid">
    </section>
    <section id="start_using_container">
        <div class="start_using_left">
            <h4>Start using the platform to find the best professional translators to match <br> your requirements</h4>
        </div>
